# ADR-0001: Plan inicial de ejecución y alcance

## Estado
Aceptado (base inicial del proyecto)

## Contexto
Este documento preserva el plan original que estaba en `README.md` para mantener trazabilidad de decisiones de producto y arquitectura en un espacio dedicado.
